...
def H_VSH_complex(m, n, r, theta, phi, mode_type, a, omega, particle_type, eps_out, mu_out):
    superscript = np.where(r <= a, 1, 3)
...
def E_(m, n, r, theta, phi, mode_type, a, omega, particle_type, eps_out, mu_out):
    return E_VSH(m, n, r, theta, phi, mode_type, a, omega, particle_type, eps_out, mu_out)


def H_(m, n, r, theta, phi, mode_type, a, omega, particle_type, eps_out, mu_out):
    return H_VSH(m, n, r, theta, phi, mode_type, a, omega, particle_type, eps_out, mu_out)


def E_cart_(m, n, x, y, z, mode_type, a, omega, particle_type, eps_out, mu_out):
...
def H_cart_(m, n, x, y, z, mode_type, a, omega, particle_type, eps_out, mu_out):
    r = np.sqrt(x**2 + y**2 + z**2)
    theta = np.arccos(z / r)
    phi = np.arctan2(y, x)
